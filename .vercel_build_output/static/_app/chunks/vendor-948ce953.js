...
let p = m ? () => window.performance.now() : () => Date.now(),
...
function E(t, n) {
	if (b) {
		for (
			!(function (t) {
				...
				for (let l = 0; l < n.length; l++) {
					const t = n[l].claim_order,
						i =
							(r > 0 && n[e[r]].claim_order <= t ? r + 1 : x(1, r, (t) => n[e[t]].claim_order, t)) -
							1;
					o[l] = e[i] + 1;
					const c = i + 1;
					(e[c] = l), (r = Math.max(c, r));
				}
				const i = [],
					c = [];
				let s = n.length - 1;
				for (let l = e[r] + 1; 0 != l; l = o[l - 1]) {
					for (i.push(n[l - 1]); s >= l; s--) c.push(n[s]);
					s--;
				}
				for (; s >= 0; s--) c.push(n[s]);
				i.reverse(), c.sort((t, n) => t.claim_order - n.claim_order);
				for (let l = 0, a = 0; l < c.length; l++) {
					for (; a < i.length && c[l].claim_order >= i[a].claim_order; ) a++;
					const n = a < i.length ? i[a] : null;
		...
		n !== t.actual_end_child
			? (void 0 === n.claim_order && n.parentNode === t) || t.insertBefore(n, t.actual_end_child)
			: (t.actual_end_child = n.nextSibling);
	} else (n.parentNode === t && null === n.nextSibling) || t.appendChild(n);
}
function A(t, n, e) {
	b && !e ? E(t, n) : (n.parentNode === t && n.nextSibling == e) || t.insertBefore(n, e || null);
}
function N(t) {
...
function T(t, n, e, o, r = !1) {
	...
	const i = (() => {
		for (let o = t.claim_info.last_index; o < t.length; o++) {
			...
			if (n(i)) {
				const n = e(i);
				return void 0 === n ? t.splice(o, 1) : (t[o] = n), r || (t.claim_info.last_index = o), i;
			}
		}
...
function mt(e, o, r) {
	...
	function d() {
		const { delay: o = 0, duration: r = 300, easing: c = n, tick: d = t, css: h } = l || _t;
		h &&
			(i = (function (t, n, e, o, r, i, c, s = 0) {
				const l = 16.666 / o;
				let a = '{\n';
				for (let p = 0; p <= 1; p += l) {
					const t = n + (e - n) * i(p);
				...
				const u = a + `100% {${c(e, 1 - e)}}\n}`,
					...
					d = v(t);
				F.add(d);
				const h = d.__svelte_stylesheet || (d.__svelte_stylesheet = w(t).sheet),
					_ = d.__svelte_rules || (d.__svelte_rules = {});
				_[f] || ((_[f] = !0), h.insertRule(`@keyframes ${f} ${u}`, h.cssRules.length));
				const m = t.style.animation || '';
				return (
					(t.style.animation = `${m ? `${m}, ` : ''}${f} ${o}ms linear ${r}ms 1 both`), (L += 1), f
				);
			})(e, 0, 1, r, o, c, h, u++)),
			d(0, 1);
		const _ = p() + o,
		...
		s && s.abort(),
			...
			(s = (function (t) {
				...
				if (a) {
					if (t >= m) return d(1, 0), st(e, !0, 'end'), f(), (a = !1);
					if (t >= _) {
						const n = c((t - _) / r);
						d(n, 1 - n);
					}
...
function xt(t, n, e, r) {
	const { fragment: s, on_mount: l, on_destroy: a, after_update: u } = t.$$;
	s && s.m(n, e),
		r ||
			nt(() => {
				const n = l.map(o).filter(c);
...
function wt(t, n) {
	-1 === t.$$.dirty[0] && (U.push(t), tt || ((tt = !0), Z.then(rt)), t.$$.dirty.fill(0)),
		(t.$$.dirty[(n / 31) | 0] |= 1 << n % 31);
}
function Et(n, e, o, c, s, l, a, u = [-1]) {
	const f = I;
	G(n);
	const d = (n.$$ = {
		fragment: null,
	...
	if (
		((d.ctx = o
			? o(n, e.props || {}, (t, e, ...o) => {
					...
					return (
						d.ctx &&
							s(d.ctx[t], (d.ctx[t] = r)) &&
							(!d.skip_bound && d.bound[t] && d.bound[t](r), h && wt(n, t)),
						e
					);
			  })
			: []),
		...
		if (e.hydrate) {
			b = !0;
			const t = R(e.target);
			d.fragment && d.fragment.l(t), t.forEach(N);
		} else d.fragment && d.fragment.c();
		e.intro && dt(n.$$.fragment), xt(n, e.target, e.anchor, e.customElement), (b = !1), rt();
	}
	G(f);
}
class At {
...
function St(n, e = t) {
	...
	function i(t) {
		if (s(n, t) && ((n = t), o)) {
			const t = !Nt.length;
			for (const e of r) e[1](), Nt.push(e, n);
			if (t) {
	...
	return {
		...
		subscribe: function (c, s = t) {
			...
			return (
				...
				c(n),
				() => {
					r.delete(l), 0 === r.size && (o(), (o = null));
				}
			);
		}
	};
}
function kt(t, { delay: e = 0, duration: o = 400, easing: r = n } = {}) {
	const i = +getComputedStyle(t).opacity;
	return { delay: e, duration: o, easing: r, css: (t) => 'opacity: ' + t * i };
}
export {
	K as A,
	e as B,
