		...
		a && (e = new a(o(t))),
		{
			...
			p(t, s) {
				...
				if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), a !== (a = t[0][1]))) {
					...
					a
						? ((e = new a(o(t))), b(e.$$.fragment), P(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else a && e.$set(i);
			},
			i(t) {
		...
		a && (e = new a(o())),
		{
			...
			p(t, s) {
				...
				if (a !== (a = t[0][2])) {
					...
					a
						? ((e = new a(o())), b(e.$$.fragment), P(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else a && e.$set(i);
			},
			i(t) {
	...
	return {
		...
		p(t, [n]) {
			...
			if ((525 & n && (c.$$scope = { dirty: n, ctx: t }), o !== (o = t[0][0]))) {
				...
				o
					? ((e = new o(i(t))), b(e.$$.fragment), P(e.$$.fragment, 1), q(e, r.parentNode, r))
					: (e = null);
			} else o && e.$set(c);
			t[4]
				? l
...
const M = {},
	...
	Y = [
		() =>
			X(
				() => import('./pages/__layout.svelte-d1d7a716.js'),
				[
					'pages/__layout.svelte-d1d7a716.js',
					'assets/pages/__layout.svelte-5041e476.css',
					'assets/ModeButton.svelte_svelte&type=style&lang-81f6bc55.css',
					'chunks/vendor-948ce953.js'
				]
			),
		() =>
			X(
				() => import('./pages/__error.svelte-11d62949.js'),
				[
					'pages/__error.svelte-11d62949.js',
					'assets/pages/__error.svelte-3ca9ba17.css',
					'chunks/vendor-948ce953.js'
				]
			),
		() =>
			X(
				() => import('./pages/index.svelte-fc3d63e9.js'),
				[
					'pages/index.svelte-fc3d63e9.js',
		...
		() =>
			X(
				() => import('./pages/about.svelte-6c74fe6f.js'),
				[
					'pages/about.svelte-6c74fe6f.js',
					'assets/pages/index.svelte-ba11f21e.css',
					'chunks/vendor-948ce953.js'
				]
			)
		...
		t: for (let v = 0; v < o.length; v += 1) {
			...
			try {
				...
				if (
					...
					const r = v === o.length - 1;
					if (t && t.loaded) {
						if (
							(t.loaded.error && ((_ = t.loaded.status), (p = t.loaded.error)), t.loaded.redirect)
						)
